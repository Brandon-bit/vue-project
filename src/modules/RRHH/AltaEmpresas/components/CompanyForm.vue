...
import { companySchema } from '@/modules/RRHH/AltaEmpresas/validations/companyValidation'
import { useCompanyActions } from '@/modules/RRHH/AltaEmpresas/composables/useCompanyActions'
import { DepartmentDTO } from '@/modules/RRHH/AltaEmpresas/types/companyTypes'

const route = useRoute()
const router = useRouter()
const isEditMode = computed(() => route.name === 'Actualizar empresa')
const pageTitle = computed(() => 
    isEditMode.value ? 'Actualizar Empresa' : 'Registrar Nueva Empresa'
)
                    ...
                    <div class="grid grid-cols-12 gap-5">
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="text-sm text-base-content/70 mt-2">
                                Se aplicarán los días festivos oficiales de México por defecto. Puedes personalizarlos después.
                            </div>
                        </div>
                    </div>
                </div>
