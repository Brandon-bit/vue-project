...
// Use useField for publicationType to handle radio buttons
                    ...
                    <div class="collapse-content text-sm mb-4">
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="text-center mt-3 mb-2 text-sm">{{ img.name }}</p>
                            </div>
                        </VueDraggable>
                    </div>
                </div>

                <!-- COLLAPSE TIPO DE PUBLICACIÓN -->
                <div class="collapse collapse-arrow bg-base-100 mb-5 border border-base-300">
                        ...
                        <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="flex flex-col gap-3">
                                    <label class="cursor-pointer flex items-center gap-3 p-4 border border-base-300 rounded-lg hover:bg-base-200 transition-all shadow-sm hover:shadow-md">
                                        <input
                                            type="radio"
