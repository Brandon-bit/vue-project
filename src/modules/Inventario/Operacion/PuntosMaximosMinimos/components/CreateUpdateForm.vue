...
const { getProductsBySearch } = useInventoryWithdrawalsActions()
...
<template>
    ...
    <BaseFormInput name="reorderPoints" type="number" label="Punto de reorden" :required="true" />
    <BaseFormInput name="suggestion" type="text" label="Sugerencia" />
</template>
