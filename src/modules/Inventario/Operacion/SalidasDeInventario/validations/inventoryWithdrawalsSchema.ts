...
export const addInventoryWithdrawalProductSchema = z.object({
...
export const createUpdateInventoryWithdrawalSchema = z.object({
    warehouseId: selectValidator('El campo  almacén es requerido'),
    destinationId: selectValidator('El campo destino es requerido'),
