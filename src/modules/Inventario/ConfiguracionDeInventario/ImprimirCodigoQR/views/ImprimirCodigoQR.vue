<template>
    ...
    <!-- Fila de configuración del código QR -->
    <div class="flex items-center gap-6 my-6">
        ...
        <!-- Toggle para número de referencia -->
        <div class="form-control">
            <label class="label cursor-pointer">
                <span class="label-text mr-4">Número de referencia</span>
                <input v-model="showReferenceNumber" type="checkbox" class="toggle toggle-primary" />
            </label>
        </div>
    </div>
...
import useImprimirCodigoQRStore from '../store/imprimirCodigoQR.store'
import { getProductsService, getStoresService, getWarehousesService } from '../services/imprimirCodigoQRServices'
import { useImprimirCodigoQR } from '../composables/useImprimirCodigoQR'

const store = useImprimirCodigoQRStore()
const loading = ref(false)
const { getProductsTableColumns } = useImprimirCodigoQR()

// Variables para configuración de código QR
const paperSize = ref('')
