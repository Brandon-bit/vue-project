...
import { createProductSchema } from '@inventario/ConfiguracionDeInventario/Productos/validations/productValidation'
...
<template>
    <form @submit="onSubmit">
        ...
        <div class="collapse collapse-arrow bg-base-100 mb-5 border border-base-300">
            ...
            <div class="collapse-title border-b-1 border-base-300 mb-6 !font-bold">Información</div>
            <div class="collapse-content text-sm">
                <div class="grid grid-cols-12 gap-5">
                    ...
                    <div class="relative col-span-12 md:col-span-6 grid grid-cols-12 gap-2">
                        <BaseFormInput class="col-span-9" name="sku" label="SKU" :required="true" />
                        <BaseButton
                            @click="generateSKU"
                                            ...
                                            <td>
                                                <div class="flex gap-4">
                                                    <BaseActionButtonTable
                                                        ...
                                                        variant="info"
                                                        tooltipText="Editar"
                                                        :onClick="() => showEditVariantModal(index)"
                                                    >
                                                    </BaseActionButtonTable>
                                                    <BaseActionButtonTable
                                                        icon="delete"
                                                        ...
                                                        :onClick="
                                                            () =>
                                                                showDeleteProductVariantModal(index)
                                                        "
                                                    >
                                                    </BaseActionButtonTable>
                                                </div>
        ...
        <div class="collapse collapse-arrow bg-base-100 mb-5 border border-base-300">
            <input type="checkbox" name="create-product-images" checked="checked" />
            <div class="collapse-title border-b-1 border-base-300 mb-6 !font-bold">Imágenes</div>
            <div class="collapse-content text-sm">
                <BaseFormInputFile
                    name="image"
